...
MFilter::MFilter()
    : math_tables_defined_(false), defocus_score_(0),
      ...
      contrast_low_limit_(25.0), contrast_upper_limit_(50.0),
      ...
      i_d_upper_limit_(400), n_i_diam_factor_(1), isgs_mean_low_limit_(10),
      ...
      max_r_trial_(60), min_p_r_trial_(8), max_p_r_trial_(32), pupil_cx_(0), pupil_cy_(0),
...
//  Decrease isgs_mean_low_limit_ from 20 to 10
//  Increase max_r_trial_ from 54 to 60
//  Decrease contrast_low_limit_ from 30 to 25
